...
@RestController
@AllArgsConstructor
@RequestMapping("/businesscollegeappraises")
@Api(value = "businesscollegeappraises", tags = "商学院评价表管理")
public class BusinessCollegeAppraisesController {
    ...
    @GetMapping("/page")
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegeappraises:index')")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegeappraises:get')")
    ...
    @SysLog("新增商学院评价表")
    @PostMapping
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegeappraises:add')")
    ...
    @SysLog("修改商学院评价表")
    @PutMapping
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegeappraises:edit')")
    ...
    @SysLog("删除商学院评价表")
    @DeleteMapping("/{id}")
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegeappraises:del')")
