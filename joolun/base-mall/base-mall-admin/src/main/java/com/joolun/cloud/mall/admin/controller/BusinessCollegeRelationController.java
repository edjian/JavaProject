...
@RestController
@AllArgsConstructor
@RequestMapping("/businesscollegerelation")
@Api(value = "businesscollegerelation", tags = "商学院关联表管理")
public class BusinessCollegeRelationController {
    ...
    @GetMapping("/page")
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegerelation:index')")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegerelation:get')")
    ...
    @SysLog("新增商学院关联表")
    @PostMapping
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegerelation:add')")
    ...
    @SysLog("修改商学院关联表")
    @PutMapping
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegerelation:edit')")
    ...
    @SysLog("删除商学院关联表")
    @DeleteMapping("/{id}")
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegerelation:del')")
