...
@RestController
@AllArgsConstructor
@RequestMapping("/businesscollegecollect")
@Api(value = "businesscollegecollect", tags = "商学院用户收藏表管理")
public class BusinessCollegeCollectController {
    ...
    @GetMapping("/page")
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegecollect:index')")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegecollect:get')")
    ...
    @SysLog("新增商学院用户收藏表")
    @PostMapping
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegecollect:add')")
    ...
    @SysLog("修改商学院用户收藏表")
    @PutMapping
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegecollect:edit')")
    ...
    @SysLog("删除商学院用户收藏表")
    @DeleteMapping("/{id}")
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegecollect:del')")
