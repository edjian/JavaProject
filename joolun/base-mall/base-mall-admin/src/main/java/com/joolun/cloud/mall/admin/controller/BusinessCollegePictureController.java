...
@RestController
@AllArgsConstructor
@RequestMapping("/businesscollegepicture")
@Api(value = "businesscollegepicture", tags = "商学院图片表管理")
public class BusinessCollegePictureController {
    ...
    @GetMapping("/page")
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegepicture:index')")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegepicture:get')")
    ...
    @SysLog("新增商学院图片表")
    @PostMapping
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegepicture:add')")
    ...
    @SysLog("修改商学院图片表")
    @PutMapping
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegepicture:edit')")
    ...
    @SysLog("删除商学院图片表")
    @DeleteMapping("/{id}")
    @PreAuthorize("@ato.hasAuthority('mall:businesscollegepicture:del')")
