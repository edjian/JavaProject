...
CREATE TABLE `wx_app` (
  `id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '应用ID',
  ...
  `del_flag` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '0' COMMENT '逻辑删除标记（0：显示；1：隐藏）',
  ...
  `is_component` char(1) DEFAULT NULL COMMENT '是否第三方平台应用（0：是；1：否）',
  ...
  `vip_card_id` varchar(64) DEFAULT NULL COMMENT '绑定的会员卡ID',
...
CREATE TABLE `wx_auto_reply` (
  ...
  `tenant_id` int(11) NOT NULL COMMENT '所属租户',
  `app_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公众号配置ID、小程序AppID',
...
CREATE TABLE `wx_menu` (
  `id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '菜单ID（click、scancode_push、scancode_waitmsg、pic_sysphoto、pic_photo_or_album、pic_weixin、location_select：保存key）',
  ...
  `tenant_id` int(11) NOT NULL COMMENT '所属租户',
  `parent_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '父菜单ID',
...
CREATE TABLE `wx_msg` (
  ...
  `wx_user_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '微信用户ID',
  ...
  `read_flag` char(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '1' COMMENT '已读标记（0：是；1：否）',
  PRIMARY KEY (`id`),
  KEY `ids_app_id` (`app_id`),
  KEY `ids_tenant_id` (`tenant_id`)
...
CREATE TABLE `wx_user` (
  ...
  `app_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公众号配置ID、小程序AppID',
  `app_type` char(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '应用类型(1:小程序，2:公众号)',
  `subscribe` char(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '是否订阅（0：是；1：否；2：网页授权用户）',
