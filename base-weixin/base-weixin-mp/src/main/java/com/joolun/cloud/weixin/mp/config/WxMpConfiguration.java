...
import com.joolun.cloud.weixin.mp.handler.MassMsgHandler;
...
import com.joolun.cloud.weixin.mp.handler.NullHandler;
...
public class WxMpConfiguration {
	...
	private static WxAppMapper wxAppMapper;
	...
	public WxMpConfiguration( LogHandler logHandler, NullHandler nullHandler
			...
			, RedisTemplate redisTemplate,WxAppMapper wxAppMapper) {
	...
	public static WxMpService getMpService(String appId) {
        ...
        if(wxMpService == null) {
        	WxApp wxApp = wxAppMapper.findByAppId(appId);
        	if(wxApp!=null) {
