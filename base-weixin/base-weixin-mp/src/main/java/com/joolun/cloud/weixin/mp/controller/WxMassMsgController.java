...
import com.joolun.cloud.weixin.mp.entity.WxMassMsg;
import com.joolun.cloud.weixin.mp.service.WxMassMsgService;
...
public class WxMassMsgController {
    ...
    */
    @GetMapping("/page")
    @PreAuthorize("@pms.hasPermission('wxmp_wxmassmsg_index')")
    ...
    */
    @GetMapping("/{id}")
    @PreAuthorize("@pms.hasPermission('wxmp_wxmassmsg_get')")
    ...
    */
    @SysLog("新增微信消息群发")
    @PostMapping
    @PreAuthorize("@pms.hasPermission('wxmp_wxmassmsg_add')")
    ...
    */
    @SysLog("修改微信消息群发")
    @PutMapping
    @PreAuthorize("@pms.hasPermission('wxmp_wxmassmsg_edit')")
    ...
    */
    @SysLog("删除微信消息群发")
    @DeleteMapping("/{id}")
    @PreAuthorize("@pms.hasPermission('wxmp_wxmassmsg_del')")
