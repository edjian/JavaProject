 ...
 */
package com.joolun.cloud.wxmp.service.impl;

import com.baomidou.mybatisplus.core.toolkit.Wrappers;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.joolun.cloud.wxmp.entity.Menu;
import com.joolun.cloud.wxmp.entity.MenuButton;
import com.joolun.cloud.wxmp.entity.WxMenu;
import com.joolun.cloud.wxmp.mapper.WxAppMapper;
import com.joolun.cloud.wxmp.mapper.WxMenuMapper;
import com.joolun.cloud.wxmp.config.WxMpConfiguration;
import com.joolun.cloud.weixin.common.entity.WxApp;
import com.joolun.cloud.wxmp.service.WxMenuService;
...
public class WxMenuServiceImpl extends ServiceImpl<WxMenuMapper, WxMenu> implements WxMenuService {
	...
	public void saveAndRelease(String appId , String strWxMenu) throws WxErrorException {
		...
		for(MenuButton menuButton : buttons){
			...
			menuButton.setKey(wxMenu.getId());
			sort1++;
			for(MenuButton menuButton1 : menuButton.getSubButtons()){
				wxMenu1 = new WxMenu();
