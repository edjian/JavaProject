...
import com.joolun.cloud.admin.api.entity.*;
import com.joolun.cloud.admin.mapper.SysTenantMapper;
import com.joolun.cloud.admin.service.*;
...
public class SysTenantServiceImpl extends ServiceImpl<SysTenantMapper, SysTenant> implements SysTenantService {
	...
	public Boolean saveTenant(SysTenant sysTenant) {
		...
		List<SysDict> dictList = dictService.list(Wrappers.<SysDict>lambdaQuery()
				.eq(SysDict::getIsSystem, DictTypeEnum.SYSTEM.getType()))
				.stream().map(dict -> {
