...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      permissionList() {
        return {
          addBtn: this.permissions['mall:goodsspec:add'],
          delBtn: this.permissions['mall:goodsspec:del'],
          editBtn: this.permissions['mall:goodsspec:edit'],
          viewBtn: this.permissions['mall:goodsspec:get']
        };
      }
    },
    methods: {
