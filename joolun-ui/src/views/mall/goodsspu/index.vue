      ...
      <avue-crud ref="crud"
        ...
        <template slot="menuLeft">
          <el-button type="primary"
                     size="small"
                     icon="el-icon-plus"
                     v-if="permissions.mall_goodsspu_add" @click="openAdd">添加商品</el-button>
        </template>
        ...
        <template slot="shelf" slot-scope="scope">
          <el-tag :type="scope.row.shelf=='0' ? 'success' : 'danger'" effect="dark" size="mini"> {{ scope.row.shelf=='0' ? '已上架' : '已下架' }} </el-tag>
        </template>
        ...
        <template slot="skusForm" slot-scope="scope">
          <SkuForm :specType="scope.row.specType" :goodsSpec="goodsSpec" :goodsSpuSpec="goodsSpuSpec" :goodsSku="goodsSku" @getGoodsSku="getGoodsSku"></SkuForm>
        </template>
        <template slot-scope="scope" slot="menu">
          <el-button icon="el-icon-edit"
                     ...
                     @click="openEdit(scope.row,scope.index)">编辑</el-button>
